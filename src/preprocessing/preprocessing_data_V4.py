...
import complete_nas_functions as complete_nas_functions
...
output_location = base_dir / "../../data_saved/data_location_V4"
...
def remove_columns_NAN(location_names, base_dir:Path, threshold:float=0.3):
    for location_name in location_names:
        df_location_path = base_dir / "../../data_saved/data_location_V4" / f"df_{location_name}.csv"
        ...
        # Enregistrement
        output_path = base_dir / "../../data_saved/data_location_V4" / f"df_{location_name}.csv"
